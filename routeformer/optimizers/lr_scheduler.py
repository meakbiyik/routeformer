...
# also found at: https://github.com/Lightning-AI/lightning-bolts/blob/master/pl_bolts/optimizers/lr_scheduler.py # noqa: E501
import math
import warnings
...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    """Sets the learning rate of parameter groups to follow a linear warmup schedule.

    Schedule is between warmup_start_lr and base_lr followed by a cosine annealing
    ...
    def __init__(
        ...
        """Set up a linear warmup learning rate scheduler.
